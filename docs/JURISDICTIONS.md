...
| 13 Hazardous energy control (LOTO) | Part 15: s.212 isolation before service, repair, test, adjust, inspect or any work requiring control of hazardous energy; s.213 no work until isolation verified; s.214 each worker assigned a personal lock "with a unique mark or identification tag"; s.214.1 each energy-isolating device secured with that worker's lock; s.215 group control procedures; s.215.1 complex group control; s.215.2 remotely controlled systems; s.215.4 pressurized piping. Part 5 s.49 hazardous energy in confined spaces. | Part 10: s.10.3 "If machinery or equipment is shut down for maintenance, no work may be done until (a) all parts and attachments have been secured against inadvertent movement, (b) where the work will expose workers to energy sources, the hazard has been effectively controlled"; s.10.4 locks per procedures available to all workers; s.10.7 each worker locks out before starting and removes own lock on completion; s.10.9 group lockout; s.10.10 alternatives where lockout not practicable (power systems per Part 19, mobile equipment per Part 16). Part 19 s.19.10 low voltage disconnected and locked out; s.19.16 high voltage isolated, grounded, locked out; Part 9 s.9.13 confined-space permit where lockout required. |
